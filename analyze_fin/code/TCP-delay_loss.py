...
# 读取数据
df = pd.read_csv('D:/Users/LLL2000/Desktop/analyze_fin/data/origin_data/TCP_20_2.csv', delimiter=',')
...
print(result_df)
# 将结果存储到文件
result_df.to_csv('D:/Users/LLL2000/Desktop/analyze_fin/data/result/TCP_20_2_result.csv', index=False)
